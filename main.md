...
Hydrodynamische software wordt gebruikt om de hydraulische afvoercapaciteit te toetsen. Naast inzicht in de te verwachten afvoerdebieten kan hiermee ook getoetst worden of luchtophoping een mogelijk knelpunt is en wat de maximaal en minimaal optredende drukken zijn. Het laatste is ook van belang bij het bepalen van de minimaal benodigde resterende buissterkte. Het GWSW kan de gegevensuitwisseling met dergelijke software vereenvoudigen.
...
| Verhoogd  risico    | gwsw:hasValue                                                      | Nee        | In kader WIBON, er geldt een verhoogd risico bij ontgraven voor deze  leiding                  |
...
| Voorzorgsmaatregel   | gwsw:hasValue                                                      | Nee        | In kader WIBON, document met bijzondere maatregelen bij ontgraven                         |
